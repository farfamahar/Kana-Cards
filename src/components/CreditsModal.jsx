              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none overflow-hidden soft-shadow pl-8 pr-8">
                ...
                <div className="relative p-6 flex-auto mr-10">
                  <p className="my-4 text-slate-700 text-md">
                    <a href="https://github.com/fama-623" target="_blank" data-testid="github-link">Developed by Farfama  <span className='ml-1'> {githubIcon} </span> </a>
                  </p>
                  <p className=" text-slate-600 text-sm">
                   <a href="https://www.tofugu.com/" target="_blank" data-testid="tofugu-link"> Mnemonic cards - Tofugu </a>
                  </p>
                  <p className=" text-slate-600 text-sm">
                  <a href="https://www.thoughtco.com/" target="_blank" data-testid="thoughtco-link"> Audio - thoughtco </a>
                  </p>
                  <p className=" text-slate-600 text-sm">
                  <a href="https://fonts.google.com/?subset=japanese" data-testid="google-link" target="_blank"> Fonts - Google fonts </a>
                  </p>
